    ...
    $(document).ready(function(){
        ...
        $(".add_button").on("click", function () {
            if(x < maxField){
                ...
                var category = $('#catInfo').data("name");
                var catid = $('#catInfo').data("id");
                // alert(unitNames);
