...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('final_tripal_stocks', function (Blueprint $table) {
            $table->id();
            $table->string('name');
            $table->string('slug');
            ...
            $table->foreign('finaltripal_id')->references("id")->on('final_tripals')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('final_tripal_stocks');
    }
};
