...
<section class="content">
  <div class="container-fluid">
    {{-- <a href="{{route('rawMaterialSalesEntry.pdf',$saleentry->id)}}"> <button class="btn btn-info btn-sm rounded-0" type="submit" ><i class="fas fa-print"></i> Pdf</button></a> --}}
    {{-- <a href="{{route('rawMaterialSalesEntry.excel',$saleentry->id)}}"> <button class="btn btn-success btn-sm rounded-0"><i class="fas fa-print"></i> Excel</button></a> --}}
        ...
        <div class="invoice p-3 mb-3 card  card-outline">
          ...
          <div class="row invoice-info p-4">
            ...
            <div class="col-sm-6 invoice-col">
              ...
              <address>
                <strong> PartyName : {{$saleentry->supplier->name}}</strong><br>

              </address>
            </div>
            {{-- <div class="col-sm-12 col-lg-6  text-right">
              <b>A/C : {{$saleentry->supplier->name}}</b><br>
              <br>
            </div> --}}
            <div class="row col-lg-12" >
                <div class="col-sm-6 col-lg-6  text-left">
                  <b>Invoice Number: {{$saleentry->bill_no}}</b><br>
                  <br>
                </div>

                <div class="col-lg-6 text-right">
                  <b>Gate Pass: {{$saleentry->gp_no}}</b><br>
                  <br>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-12 text-right ml-2">
                  <b>Date: {{$saleentry->bill_date}}</b><br>
                  <br>
                </div>
            ...
            <div class="col-12 table-responsive">
              <table class="table table-bordered" style="padding: 0 30px; ">
                ...
                <tr>
                    ...
                    <th width="10px">{{ __('Dana Name') }}</th>
                    <th width="10px">{{ __('Dana Group') }}</th>
                    <th width="10px">{{ __('Quantity') }}</th>
                </tr>
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{$key+1}}</td>
                        <td>{{$data->danaName->name}}</td>
                        <td>{{$data->danaGroup->name}}</td>
