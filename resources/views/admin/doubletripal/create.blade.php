        ...
        <div class="row">
            ...
            <div class="col-md-2 form-group">
                ...
                <input type="date" value="{{ $bill_date }}" step="any" min="0" class="form-control calculator"
                    id="billDate" data-number="1" name="bill_date" placeholder="{{ __('Remarks') }}" min="1" readonly>
...
<div class="row">
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <p style="font-weight: bold;">DoubleLaminated</p>
            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id='sendtolaminationform' action='{{ route("doubletripal.store") }}' method="post">
                    ...
                    <input type="hidden" name="godam_id" id="godam_ids"  value="{{$find_data->godam_id}}">
