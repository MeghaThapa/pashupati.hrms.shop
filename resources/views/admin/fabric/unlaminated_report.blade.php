...
@section('content')
    ...
    <div class="content-header mb-4">
        <div class="row align-items-center">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">{{ __('Unlaminated Fabric Report') }}</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item">
                        <a href="{{ route('dashboard') }}">{{ __('Report') }}</a>
                    </li>
                    <li class="breadcrumb-item active">{{ __('Unlaminated Fabric Report') }}</li>
                </ol>
            </div>
        </div>
    </div>
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <h3>Unlaminated Fabric Report</h3>
                </div>
    ...
    <script>
        $(function(){
            ...
            $("#generateReport").click(function(e) {
                e.preventDefault()
                $.ajax({
                    url: "{{ route('fabric.unlaminated.report.view') }}",
                    method: "post",
                    data: {
