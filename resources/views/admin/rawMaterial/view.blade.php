                ...
                <small class="float-right">Date: </small>
                        ...
                        <div class="row invoice-info p-4">
                            ...
                            <div class="col-sm-6 invoice-col">
                                ...
                                <address>
                                    <strong> PartyName : {{ $rawMaterial->supplier->name ?? 'GODAM TRASFER' }}</strong><br>
                                </address>
                            </div>
                            <div class="col-sm-12 col-lg-6  text-right">
                                <b>A/C : {{ $rawMaterial->supplier->name ?? 'GODAM TRASFER' }}</b><br>
                                <br>
                            </div>
                            <div class="row col-lg-12">
                                <div class="col-sm-6 col-lg-6  text-left">
                                    <b>Invoice Number: {{ $rawMaterial->bill_no }}</b><br>
                                    <br>
                                </div>

                                <div class="col-lg-6 text-right">
                                    <b>Gate Pass: {{ $rawMaterial->gp_no }}</b><br>
                                    <br>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-12 table-responsive">
                                <table class="table table-bordered" style="padding: 0 30px; ">
                                    ...
                                    <tbody>
                                        @foreach ($rawMaterial->rawMaterialsItem as $key => $item)
                                            <tr>
                                                <td>{{ $key + 1 }}</td>
                                                <td>{{ $item->lorry_no }}</td>
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <td>{{ $rawMaterial->raw_materials_item_sum_quantity }}</td>
