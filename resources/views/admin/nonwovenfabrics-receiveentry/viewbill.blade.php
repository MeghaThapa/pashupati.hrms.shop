        ...
        <div class="invoice p-3 mb-3 card  card-outline">
          ...
          <div class="row invoice-info p-4">
            ...
            <div class="col-sm-6 invoice-col">
              ...
              <address>
                <strong> Plantype : {{$find_data->getPlantType->name}}</strong><br>
            ...
            <div class="row col-lg-12" >
                ...
                <div class="col-lg-6 text-right">
                  <b>Plantname : {{$find_data->getPlantName->name}}</b><br>
                  <br>
                </div>
          ...
          <h3 class="m-0 text-center mt-2">Nonwoven Entry</h3>
          <div class="row">
            <div class="col-12 table-responsive">
                <table class="table table-striped table-sm">
                  ...
                  <tr>
                      ...
                      <th width="10px">{{ __('Fabric Roll') }}</th>
                      <th width="10px">{{ __('Fabric Gsm') }}</th>
                      <th width="10px">{{ __('Fabric Name ') }}</th>
                      <th width="10px">{{ __('Fabric Color') }}</th>
                      <th width="10px">{{ __('Length') }}</th>
                      <th width="10px">{{ __('Gross Weight') }}</th>
                      <th width="10px">{{ __('Net Weight') }}</th>
                  </tr>
                  ...
                  <tbody>
                      ...
                      <tr>
                          <td>{{$key+1}}</td>
                          <td>{{$data->fabric_roll}}</td>
                          <td>{{$data->fabric_gsm}}</td>
                          <td>{{$data->fabric_name}}</td>
                          <td>{{$data->fabric_color}}</td>
