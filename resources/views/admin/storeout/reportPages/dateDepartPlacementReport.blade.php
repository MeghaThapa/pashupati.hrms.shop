        ...
        <div class="container-fluid">
            <div class="card">
                ...
                <div class="row container">
                    ...
                    <div class="col-sm-3">
                        <label for="srNo">Department</label>
                    ...
                    <div class="col-sm-3">
                        <label for="srNo">Placement</label>
...
@section('extra-script')
    ...
    <script>
        $(function() {
            ...
            $('#department,#for').on('change', function(e) {
                e.preventDefault();
                console.log('megha');
                $.ajax({
                    url: "{{ route('storeout.getPlacement') }}",
                    method: "GET",
                    data: {
                    ...
                    success: function(response) {
                        $('#placement').empty();
                        $('#placement').prepend(
                            "<option value='' disabled selected>Select required placement</option>"
                        );
                        response.forEach(function(obj) {
                            setOptionInSelect('placement', obj.id, obj
                                .name)
                        });
            ...
            function setOptionInSelect(elementId, optionId, optionText) {
                ...
                newOption.val(optionId).text("Please select placement");
            ...
            $("#generateReport").click(function(e) {
                e.preventDefault()
                $.ajax({
                    url: "{{ route('storeout.generatedateDepartPlacementReport.view') }}",
                    method: "post",
                    data: {
