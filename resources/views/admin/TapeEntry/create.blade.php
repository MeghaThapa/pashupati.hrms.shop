                        ...
                        @foreach($tapeentries as $data)
                            <div class='row mt-2'>
                                <div class="col-md-4">
                                    ...
                                    <input type="date" name="tape_receive_date" class="form-control" value="{{ $data->tape_entry_date }}" readonly required/>
                                </div>
                                <div class="col-md-4">
                                    <label for="receipt_no">Receipt Number</label>
                                    <input type="text" value="{{ $data->receipt_number }}" id="receipt_number_1_repeat" name="receipt_number" class="form-control" readonly required/>
                                </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="mt-2">
                                            ...
                                            <hr>
                                            <button class="btn btn-primary float-right" id="add_new_dana_to_autoloader_stock" disabled>Add</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
