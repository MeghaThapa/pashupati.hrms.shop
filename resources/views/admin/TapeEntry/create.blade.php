                ...
                <form id="tape_entry_form" action="{{ route('tape.entry.stock.store') }}" method="post">
                    ...
                    <div class='row mt-2'>
                        <div class="col-md-3">
                            ...
                            <input type="text" class="form-control" name="total_in_kg" id="total_in_kg" disabled
                                required />
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" class="form-control" name="bypass_wast" id="bypass_wast" disabled
                                required />
                        </div>
                    </div>
                    <div class="row mt-2">
                        <div class="col-md-6">
                            ...
                            <select name="tapetype" id="tapetype" name="tapetype" class='advance-select-box select2'
                               disabled required>
