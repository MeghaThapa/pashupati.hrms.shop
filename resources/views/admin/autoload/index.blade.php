                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 form-group">
                                            ...
                                            <label for="size" class="col-form-label">{{ __('Transfer Date') }}<span
                                                    class="required-field">*</span>
                                            </label>
                                            <input type="date" step="any" min="0"
                                                class="form-control calculator" id="transferDate" data-number="1"
                                                name="transfer_date" placeholder="{{ __('Transfer Date') }}" min="1"
                                                required>
                                            @error('transfer_date')
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 form-group">
                                            ...
                                            <input type="text" step="any" min="0"
                                                class="form-control calculator" id="receiptNo" data-number="1"
                                                name="receipt_no" placeholder="{{ __('Transfer Date') }}" min="1"
                                                required readonly>
                                            @error('receipt_no')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <form id="UpdateAutoloadModel" action="{{ route('autoload.update') }}" method="POST">
                            <div class="modal-body">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 form-group">
                                            <input type="text" step="any" min="0"
                                                class="form-control calculator" id="autoloadIdModel" data-number="1"
                                                name="autoload_id_model" min="1" required hidden>
                                            <label for="size" class="col-form-label">{{ __('Transfer Date') }}<span
                                                    class="required-field">*</span>
                                            </label>
                                            <input type="date" step="any" min="0"
                                                class="form-control calculator" id="transferDateModel" data-number="1"
                                                name="transfer_date_model" placeholder="{{ __('Transfer Date') }}"
                                                min="1" required>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 form-group">
                                            ...
                                            <input type="text" step="any" min="0"
                                                class="form-control calculator" id="receiptNoModel" data-number="1"
                                                name="receipt_no_model" placeholder="{{ __('Transfer Date') }}"
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                <button type="submit" id="hello" class="btn btn-primary edit-btn">Update
                                    AutoLoad</button>
                            </div>
                        </form>
                    </div>
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                window.location.href =
                                    "{{ route('autoLoad.createAutoloadItem', ['autoload_id' => ':Replaced']) }}"
                                    .replace(
                                        ':Replaced',
                                        autoload_id),
                    ...
                    new swal({
                        ...
                        .then((willDelete) => {
                            if (willDelete.isConfirmed) {
                                $.ajax({
                                    type: "DELETE",
                                    url: "{{ route('autoload.delete', ['autoload_id' => ':Replaced']) }}"
                                        .replace(
                                            ':Replaced',
                                            autoload_id),
                                    data: {
