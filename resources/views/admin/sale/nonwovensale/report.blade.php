...
@section('content')
    ...
    <div class="content-header mb-4">
        <div class="row align-items-center">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">{{ __('Non Woven Sales Report') }}</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">{{ __('Non Woven Sales Report') }}</li>
                </ol>
            </div>
        </div>
    </div>
    ...
    <script>
        $(function(){
            ...
            $("#generateReport").click(function(e) {
                e.preventDefault()
                $.ajax({
                    url: "{{ route('nonwovenSale.generateReport') }}",
                    method: "post",
                    data: {
