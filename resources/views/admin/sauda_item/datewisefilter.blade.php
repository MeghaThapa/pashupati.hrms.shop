    ...
    <div class="content-header mb-4">
        <div class="row align-items-center">
            <div class="col-sm-6 mt-2">
                <h4><strong>Sauda Item Pending Report Datewise and Order For Report</strong></h4>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">{{ __('Sauda Item Pending Report Datewise and Order For Report') }}</li>
                </ol>
            </div>
        </div>
    </div>
        ...
        <div class="container-fluid">
            <div class="card mt-3">
                <div class="card-header">
                    <h4>Sauda Item Pending Report Datewise and Order For </h4>
                </div>
                <div class="card-body">
                    <form id="generate" method="POST" action="{{ route('sauda.item.datewise.generate.view') }}">
                        @csrf
                    <div class="row">
                        <div class="col-sm-3">
