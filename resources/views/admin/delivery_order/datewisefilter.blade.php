        ...
        <div class="container-fluid">
            <div class="card mt-3">
                <div class="card-header">
                    <h4>Delivery Order Report Datewise</h4>
                </div>
                <div class="card-body">
                    <form id="generate" method="POST" action="{{ route('delivery.order.datewise.generate.view') }}">
                        @csrf
                    <div class="row">
                        <div class="col-sm-3">
                        ...
                        <div class="col-sm-3">
                            ...
                            <select class="form-control" name="status">
                                ...
                                <option value="Approved & Delivered">Approved & Delivered</option>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row" style="width: 100%;">
                        <div class="col-sm-4">
                            <a class="btn btn-success" href="{{ route('delivery-order.index') }}">Delivery Order List and entry</a>
                        </div>
                        <div class="col-sm-4">
                            <h4> Datewise Delivery Order Report</h4>
                        </div>
                    </div>
                </div>
