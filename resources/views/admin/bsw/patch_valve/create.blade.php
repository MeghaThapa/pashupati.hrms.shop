...
@section('content')
    <div class="card-body p-0 m-0">
        <form action="{{ route('fabSendCuetxReceivePatchValveEntry.store') }}" method="post">
            @csrf
            <div class="row">
                <div class="col-md-2 form-group">
                    <label for="size" class="col-form-label">{{ __('Receipt No') }}<span class="required-field">*</span>
                    </label>
                    <input type="text" class="form-control" id="receiptNo" name="receipt_no" value="{{ $receipt_no }}"
                        required />
                </div>
