        ...
        <form id="createRawMaterial">
            ...
            <div class="row">
                ...
                <div class="col-md-2 form-group">
                    ...
                    <input type="date" value="{{ $data->bill_date }}" step="any" min="0"
                        class="form-control calculator" id="billDate" data-number="1" name="bill_date" min="1"
                        disabled required>
                ...
                <div class="col-md-2 form-group">
                    ...
                    <select class="form-control" id="plantType" name="plant_type_id" disabled required>
                        ...
                        <option value="{{ $data->planttype_id }}" selected readonly required>
                            {{ $data->getplanttype->name }}</option>
                ...
                <div class="col-md-2 form-group">
                    ...
                    <select class="form-control" id="plantName" name="plant_name_id" disabled required>
                        ...
                        <option value="{{ $data->plantname_id }}" selected readonly>{{ $data->getplantname->name }}
                        </option>
            ...
            <div class="row">
                ...
                <div class="col-md-2 form-group">
                    ...
                    <input type="text" step="any" min="0" class="form-control calculator"
                        id="rollnumberfabric" data-number="1" name="roll_number" min="1" required>
                ...
                <div class="card-body">
                    ...
                    <div class="row p-2">
                        ...
                        <div class="col-md-6">
                            ...
                            <label for="size" class="col-form-label">{{ __('Dana:') }}<span
                                    class="required-field">*</span>
                        ...
                        <div class="col-md-6">
                            ...
                            <label for="size" class="col-form-label">{{ __('Enter Qty:') }}<span
                                    class="required-field">*</span>

                            </label>

                            <input type="number" step="any" min="0" class="form-control"
                                id="add_dana_consumption_quantity" data-number="1" name="total_ul_in_mtr" min="1"
                                disabled required>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 form-group">
                            ...
                            <div>
                                ...
                                <input type="text" step="any" min="0" class="form-control calculator"
                                    id="total_lam_in_mtr" data-number="1" name="total_lam_in_mtr" min="1"
                                    readonly required>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" step="any" min="0" class="form-control calculator"
                                    id="total_lam_net_wt" data-number="1" name="total_lam_net_wt" min="1"
                                    readonly required>
                            ...
                            <div>
                                ...
                                <input type="text" step="any" min="0" class="form-control calculator"
                                    id="total_waste" data-number="1" name="total_waste" min="1" readonly
                                    required>
                        ...
                        <div class="col-md-4" style="margin-top:70px;">
                            ...
                            <div>
                                ...
                                <input type="text" step="any" min="0" class="form-control calculator"
                                    id="diff_unLam_lamNw" data-number="1" name="diff_unLam_lamNw" min="1"
                                    readonly required>
        ...
        <div class="modal-dialog modal-dialog-centered modal-xl">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <button type="button" class="btn-rounded btn-primary" data-bs-dismiss="modal"
                            ...
                            <div class="card-body">
                                ...
                                <div class="row m-2 p-3 d-flex justify-content-center">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <input class='form-control' type="text" name="meter1" id="meter">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <input class='form-control' type="text" name="laminated_gram"
                                            id="laminated_gram">
                                ...
                                <div class="row m-2 p-3 d-flex justify-content-center">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <input class='form-control' type="text" name="meter2" id="meter2">
                                ...
                                <div class="row m-2 p-3 d-flex justify-content-center">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <input class='form-control' type="text" name="meter3" id="meter3">
    ...
    <div id="deleteModal" class="modal" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Temp Lamp data will be removed</p>
                    <input type="hidden" id="delete_lam_id" />
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary confirm_lam_delete">Confirm</button>
    ...
    <div id="deleteModal2" class="modal" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Temp Lamp data will be removed</p>
                    <input type="hidden" id="delete_unlam_id" />
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary confirm_unlam_delete">Confirm</button>
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                </div>
            </div>
        </div>
...
@section('extra-script')
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.del_lam', function() {
                $('#deleteModal').modal('show');
                $('#delete_lam_id').val($(this).data('row'));
            });

            $(document).on('click', '.del_unlam', function() {
                $('#deleteModal2').modal('show');
                $('#delete_unlam_id').val($(this).data('row'));
            });

            $(document).on('click', '.confirm_lam_delete', function(e) {
                e.preventDefault()

                $.ajax({
                    url: "{{ route('fabric.send.receive.lam.destroy') }}",
                    method: "post",
                    data: {
            ...
            $(document).on('click', '.confirm_unlam_delete', function(e) {
                e.preventDefault()

                $.ajax({
                    url: "{{ route('fabric.send.receive.unlam.destroy') }}",
                    method: "post",
                    data: {
                        "_token": $("meta[name='csrf-token']").attr("content"),
        ...
        function callunlaminatedfabricajax() {
            ...
            $.ajax({
                ...
                url: "{{ route('fabricSendReceive.get.unlaminated.revised', ['fsr_entry_id' => ':fsr_entry_id']) }}"
                    .replace(":fsr_entry_id", $("#fsr_entry_id").val()),
        ...
        function deletefromunlamintedtable(data) {
            ...
            $.ajax({
                ...
                url: "{{ route('fabricSendReceive.send.unlaminated.delete.revised', ['id' => ':id']) }}".replace(
                    ':id', data),
        ...
        function comparelamandunlam() {
            ...
            $.ajax({
                ...
                url: "{{ route('fabricSendReceive.compare.lamandunlam.revised', ['entry_id' => ':entry_id']) }}"
                    .replace(':entry_id', $("#fsr_entry_id").val()),
        ...
        function putdanaNameId(data) {
            ...
            data.data.forEach(d => {
                ...
                $("#danaNameId").append(
                    `<option autoloaderid="${d.id}" value="${d.dana_name.id}">${d.dana_name.name}</option>`);
                    ...
                    success: function(response) {
                        ...
                        if (response == '200') {
                            ...
                            setTimeout(function() {
                                ...
                                location.href =
                                    "{{ route('fabricSendReceive.entry.create') }}";
