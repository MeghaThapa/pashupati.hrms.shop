    ...
    <form action="{{ route('openingtripal.storeSingleStock') }}" method="post" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-md-2 form-group">
                ...
                <label for="size" class="col-form-label">{{ __('SingleTripal Name') }}<span class="required-field">*</span>
                </label>
                <select class="advance-select-box form-control" id="singletripal" name="fabric_id"
                    required>
                    <option value="">{{ __('Select SingleTripal Name') }}</option>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h5 class="modal-title" id="exampleModalcat">Add SingleTripal Name</h5>
            ...
            <form action="{{ route('singletripal.storeName') }}" method="post" id="tripal_form">
                @csrf
...
<script type="text/javascript">
  $("body").on("change","#singletripal", function(event){
    var singletripal = $('#singletripal').val(),
    ...
    $.ajax({
      type:"POST",
      dataType:"JSON",
      url:"{{route('getFilterSingleTripalList')}}",
      data:{
        _token: token,
        singletripal: singletripal,
      },
