...
@section('content')
    ...
    <div class="content-header mb-4">
        <div class="row align-items-center">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">{{ __('TripalGodam') }}</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">{{ __('TripalGodam') }}</li>
                </ol>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-md-7 col-6">
                    <div class="card-tools text-md-right">
                        ...
                        <a href="{{ route('tripalGodamTransfer.create') }}" class="btn btn-primary">
                            {{ __('Add TripalGodam') }} <i class="fas fa-plus-circle"></i>
                        </a>
                    </div>
                </div>
            </div>
            ...
            <script>
                $('document').ready(function() {
                    var table = $('#rawMaterialTable').DataTable({
                        ...
                        processing: true,
                        serverSide: true,
                        ajax: "{{ route('tripalGodam.dataTable') }}",
                        columns: [{
                                data: 'DT_RowIndex'
                            },
                            {
