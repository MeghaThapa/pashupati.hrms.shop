...
<div class="card-body p-0 m-0">
    <form class="form-horizontal" action="{{ route('finaltripalbill.store') }}" method="post" enctype="multipart/form-data">
        @csrf
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <a target="_blank" href="{{ route('addfinaltripal.create', $data->id) }}"
