...
@section('template_title')
    {{ trans('environment_classic_templateTitle') }}
@endsection

@section('title')
    <i class="fa fa-code fa-fw" aria-hidden="true"></i> {{ trans('environment_classic_title') }}
@endsection
        ...
        <div class="buttons buttons--right">
            <button class="button button--light" type="submit">
            	<i class="fa fa-floppy-o fa-fw" aria-hidden="true"></i>
             	{!! trans('environment_classic_save') !!}
            </button>
        </div>
    </form>
