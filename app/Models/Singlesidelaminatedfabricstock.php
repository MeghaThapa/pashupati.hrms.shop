...
class Singlesidelaminatedfabricstock extends Model
{
    ...
    protected $fillable = [
        ...
        'plantname_id','department_id','planttype_id','bill_number','bill_date',"status",'name','slug','loom_no','average_wt','singlelamfabric_id','type_lam','status','fabric_id','singletripalname_id','bill_id'
    ];
