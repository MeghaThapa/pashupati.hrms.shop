...
class NonwovenDanaConsumptionController extends Controller
{
    public function store(Request $request)
    {
        ...
        try{
            ...
            $printsCutsDanaConsumption=NonwovenDanaConsumption::where('bill_id', $request->bill_id)
            ...
            if($printsCutsDanaConsumption){
               ...
               $printsCutsDanaConsumption->save();
                ...
                $find_bill = NonwovenBill::find($request->bill_id);

                $printsCutsDanaConsumption=new NonwovenDanaConsumption();
    ...
    public function delDanaConsumption($id){

        try{

           DB::beginTransaction();

           $find_data = NonwovenDanaConsumption::find($id);
           $find_bill = NonwovenBill::find($find_data->bill_id);
